...
_testnice:     file format elf32-i386
...
{
  12:	51                   	push   %ecx
  13:	83 ec 4c             	sub    $0x4c,%esp
    pid = getpid();
  16:	e8 d8 03 00 00       	call   3f3 <getpid>
    printf(1, "Current pid: %d\n", pid);
  ...
  2f:	56                   	push   %esi
  30:	53                   	push   %ebx
  31:	e8 dd 03 00 00       	call   413 <getprocinfo>
    // r - getpid();

    if (r == 0)
  36:	83 c4 10             	add    $0x10,%esp
  39:	85 c0                	test   %eax,%eax
  3b:	75 6e                	jne    ab <main+0xab>
    {

        printf(1, "Before change -> nice: %d, privileged: %d\n", info.nice, info.is_privileged);
  3d:	ff 75 e4             	push   -0x1c(%ebp)
  40:	ff 75 e0             	push   -0x20(%ebp)
  43:	68 c0 08 00 00       	push   $0x8c0
  48:	6a 01                	push   $0x1
  ...
  64:	6a 05                	push   $0x5
  66:	53                   	push   %ebx
  67:	e8 af 03 00 00       	call   41b <nice>
  ...
  6e:	56                   	push   %esi
  6f:	53                   	push   %ebx
  70:	e8 9e 03 00 00       	call   413 <getprocinfo>
    // r = getpid();

    if (r == 0)
  75:	83 c4 10             	add    $0x10,%esp
  78:	85 c0                	test   %eax,%eax
  7a:	74 42                	je     be <main+0xbe>
  ...
  8c:	58                   	pop    %eax
  8d:	5a                   	pop    %edx
  8e:	6a fb                	push   $0xfffffffb
  90:	53                   	push   %ebx
  91:	e8 85 03 00 00       	call   41b <nice>
  ...
  98:	56                   	push   %esi
  99:	53                   	push   %ebx
  9a:	e8 74 03 00 00       	call   413 <getprocinfo>
    // r == getpid();

    if (r == 0)
  9f:	83 c4 10             	add    $0x10,%esp
  a2:	85 c0                	test   %eax,%eax
  a4:	74 2f                	je     d5 <main+0xd5>
    ...
    exit();
  a6:	e8 c8 02 00 00       	call   373 <exit>
        printf(1, "getprocinfo failed\n");
  ab:	50                   	push   %eax
  ac:	50                   	push   %eax
  ad:	68 79 08 00 00       	push   $0x879
  b2:	6a 01                	push   $0x1
  b4:	e8 47 04 00 00       	call   500 <printf>
  b9:	83 c4 10             	add    $0x10,%esp
  bc:	eb 94                	jmp    52 <main+0x52>
        printf(1, "After nice 5 -> nice: %d, privileged: %d\n",
  be:	ff 75 e4             	push   -0x1c(%ebp)
  c1:	ff 75 e0             	push   -0x20(%ebp)
  c4:	68 f0 08 00 00       	push   $0x8f0
  c9:	6a 01                	push   $0x1
  cb:	e8 30 04 00 00       	call   500 <printf>
  d0:	83 c4 10             	add    $0x10,%esp
  d3:	eb a7                	jmp    7c <main+0x7c>
        printf(1, "After nice -5 attempt -> nice: %d, privileged: %d\n",
  d5:	ff 75 e4             	push   -0x1c(%ebp)
  d8:	ff 75 e0             	push   -0x20(%ebp)
  db:	68 1c 09 00 00       	push   $0x91c
  e0:	6a 01                	push   $0x1
  e2:	e8 19 04 00 00       	call   500 <printf>
  e7:	83 c4 10             	add    $0x10,%esp
  ea:	eb ba                	jmp    a6 <main+0xa6>
  ec:	66 90                	xchg   %ax,%ax
  ee:	66 90                	xchg   %ax,%ax
  f0:	66 90                	xchg   %ax,%ax
  f2:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48b:	39 d9                	cmp    %ebx,%ecx
    buf[i++] = digits[x % base];
 48d:	0f b6 92 a8 09 00 00 	movzbl 0x9a8(%edx),%edx
  }while((x /= base) != 0);
 ...
 509:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 573:	ff 24 85 50 09 00 00 	jmp    *0x950(,%eax,4)
...
free(void *ap)
{
 ...
 6e1:	a1 bc 09 00 00       	mov    0x9bc,%eax
{
 ...
 729:	5b                   	pop    %ebx
  freep = p;
 72a:	89 15 bc 09 00 00    	mov    %edx,0x9bc
}
 730:	5e                   	pop    %esi
 731:	5f                   	pop    %edi
 732:	5d                   	pop    %ebp
 ...
 767:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 76a:	89 15 bc 09 00 00    	mov    %edx,0x9bc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 78c:	8b 15 bc 09 00 00    	mov    0x9bc,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7cb:	39 05 bc 09 00 00    	cmp    %eax,0x9bc
 ...
 7ee:	e8 ed fe ff ff       	call   6e0 <free>
  return freep;
 7f3:	8b 15 bc 09 00 00    	mov    0x9bc,%edx
 ...
 81c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 81f:	89 15 bc 09 00 00    	mov    %edx,0x9bc
}
 ...
 82f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 830:	c7 05 bc 09 00 00 c0 	movl   $0x9c0,0x9bc
 837:	09 00 00 
    base.s.size = 0;
 83a:	b8 c0 09 00 00       	mov    $0x9c0,%eax
    base.s.ptr = freep = prevp = &base;
 83f:	c7 05 c0 09 00 00 c0 	movl   $0x9c0,0x9c0
 846:	09 00 00 
    base.s.size = 0;
 849:	c7 05 c4 09 00 00 00 	movl   $0x0,0x9c4
 850:	00 00 00 
    if(p->s.size >= nunits){
