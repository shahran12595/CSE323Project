...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40b:	39 d9                	cmp    %ebx,%ecx
    buf[i++] = digits[x % base];
 40d:	0f b6 92 74 08 00 00 	movzbl 0x874(%edx),%edx
  }while((x /= base) != 0);
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 628:	bf 15 08 00 00       	mov    $0x815,%edi
...
free(void *ap)
{
 ...
 661:	a1 88 08 00 00       	mov    0x888,%eax
{
 ...
 6a9:	5b                   	pop    %ebx
  freep = p;
 6aa:	89 15 88 08 00 00    	mov    %edx,0x888
}
 6b0:	5e                   	pop    %esi
 6b1:	5f                   	pop    %edi
 6b2:	5d                   	pop    %ebp
 ...
 6e7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ea:	89 15 88 08 00 00    	mov    %edx,0x888
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 15 88 08 00 00    	mov    0x888,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74b:	39 05 88 08 00 00    	cmp    %eax,0x888
 ...
 76e:	e8 ed fe ff ff       	call   660 <free>
  return freep;
 773:	8b 15 88 08 00 00    	mov    0x888,%edx
 ...
 79c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 79f:	89 15 88 08 00 00    	mov    %edx,0x888
}
 ...
 7af:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 88 08 00 00 8c 	movl   $0x88c,0x888
 7b7:	08 00 00 
    base.s.size = 0;
 7ba:	b8 8c 08 00 00       	mov    $0x88c,%eax
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 8c 08 00 00 8c 	movl   $0x88c,0x88c
 7c6:	08 00 00 
    base.s.size = 0;
 7c9:	c7 05 90 08 00 00 00 	movl   $0x0,0x890
 7d0:	00 00 00 
    if(p->s.size >= nunits){
